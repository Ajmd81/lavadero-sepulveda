...
|----------|-------|-------|
| `VITE_API_URL` | `https://lavaderosepulveda.es/api` | URL del backend en producción |
...
vercel env add VITE_API_URL https://lavaderosepulveda.es/api
...
- **Producción**: `https://lavaderosepulveda.es/api`
...
1. Verifica que en Vercel Settings → Environment Variables esté:
   - `VITE_API_URL = https://lavaderosepulveda.es/api`
...
3. Verifica que el backend está en línea: `https://lavaderosepulveda.es/api/actuator/health`
