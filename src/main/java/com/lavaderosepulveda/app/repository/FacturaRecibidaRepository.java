...
public interface FacturaRecibidaRepository extends JpaRepository<FacturaRecibida, Long> {
    ...
    List<FacturaRecibida> findByFechaFacturaBetween(@Param("inicio") LocalDate inicio, @Param("fin") LocalDate fin);
    ...
    BigDecimal totalPorCategoria(@Param("categoria") CategoriaGasto categoria, @Param("inicio") LocalDate inicio, @Param("fin") LocalDate fin);
