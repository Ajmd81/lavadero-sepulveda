...
public enum TipoLavado {
    ...
    LAVADO_INTERIOR_TURISMO("Lavado Interior Turismo", 17.0),
    LAVADO_EXTERIOR_TURISMO("Lavado Exterior Turismo", 13.0),
    ...
    LAVADO_COMPLETO_MONOVOLUMEN("Lavado Completo Monovolumen/Todoterreno Pequeño", 30.0),
    LAVADO_INTERIOR_MONOVOLUMEN("Lavado Interior Monovolumen/Todoterreno Pequeño", 20.0),
    LAVADO_EXTERIOR_MONOVOLUMEN("Lavado Exterior Monovolumen/Todoterreno Pequeño", 15.0),
    LAVADO_COMPLETO_TODOTERRENO("Lavado Completo Todoterreno Grande", 35.0),
    LAVADO_INTERIOR_TODOTERRENO("Lavado Interior Todoterreno Grande", 22.0),
    LAVADO_EXTERIOR_TODOTERRENO("Lavado Exterior Todoterreno Grande", 18.0),
